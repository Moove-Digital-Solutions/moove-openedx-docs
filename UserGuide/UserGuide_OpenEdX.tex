...
\fancyhead[R]{\textbf{User Guide v3.0}}
...
Welcome to the Moove Education Platform. This guide provides step‑by‑step instructions for all user activities, organised into two main sections: \textbf{Educator Features} (for instructors and course staff) and \textbf{Learner Features} (for students). It also includes important \textbf{Security and Privacy} guidelines that every user must follow to help protect the platform and personal data.
